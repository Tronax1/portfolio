      ...
      <React.Fragment>
          ...
          <div className="Gradient"> 
             ...
             <div className = "ProjectContent">
                  ...
                  <Modal onClose={this.showModal2} show={this.state.show2} img={Knight} 
                  info="This is a player vs AI game
                  where both players move a chess knight around the board, and whoever runs out of moves looses." 
                  ...
                  <Modal onClose={this.showModal4} show={this.state.show4} img={TicTacToe} info="Simple Tic-Tac-Toe game
