            ...
            <div className="Nav-Mobile">
                ...
                :
                    (<div className="Nav-Flex-Mobile">
                        <NavLink className="Nav-Elements" to="/About" onClick={this.props.onClose}>Acerca</NavLink>
                        <NavLink className="Nav-Elements" to="/Resume" onClick={this.props.onClose}>Hoja de Vida</NavLink>
                        <NavLink className="Nav-Elements" to="Projects" onClick={this.props.onClose}>Proyectos</NavLink>
                        <NavLink className="Nav-Elements" to="/Contact" onClick={this.props.onClose}>Contactame</NavLink>
                    </div>)}
